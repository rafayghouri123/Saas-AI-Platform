...
export const FilesViews = () => {
    ...
    const { topElementRef, isLoadingFirstPage, isLoadingMore, canLoadMore, handleLoadmore } = useInfiniteScroll({
        status: files.status,
    ...
    const [seletedFile, setSeletedFile] = useState<PublicFile |null>(null)
            ...
            <div className="flex min-h-screen flex-col bg-muted p-8">
                <div className="mx-auto w-full max-w-screen-md">
                    <div className="space-y-2">
                        ...
                        <p className="text-muted-foreground">Upload and manage documents for your AI assistance </p>
                    </div>
